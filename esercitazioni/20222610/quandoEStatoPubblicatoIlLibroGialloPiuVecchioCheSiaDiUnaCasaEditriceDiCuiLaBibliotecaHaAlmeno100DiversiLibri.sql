...
CREATE VIEW
    CaseEditriciDiCuiLaBibliotecaHaAlmeno100DiversiLibri (Casa) = (
        SELECT CasaEd
        FROM DATILIBRO NATURAL JOIN COPIA -- verifico di avere una copia del libro presente in datilibro
        GROUP BY CasaEd
        HAVING
